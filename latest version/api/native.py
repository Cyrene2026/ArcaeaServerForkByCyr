...
api_responses = {
    ...
    400: {'model': ApiErrorResponse, 'description': 'Bad request or invalid JSON'},
    401: {'model': ApiErrorResponse, 'description': 'Missing or invalid API token'},
    403: {'model': ApiErrorResponse, 'description': 'Insufficient API permission'},
